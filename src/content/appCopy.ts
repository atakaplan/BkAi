...
export const appCopy = {
  ...
  questionCreate: {
    ...
    workspaceNav: [
      ...
      {
        id: "kompozisyon",
        label: "Kompozisyon ve rubrik oluştur",
        icon: "mdi:file-document-edit-outline",
      },
      {
        id: "ev",
        label: "Ev çalışması oluştur",
    ...
    modeWorkspaces: {
      placeholderNote:
        "Bu mod için arayüz ve servis bağlantıları hazırlanıyor.",
    },
    modes: {
      metodbox: {
  ...
  questionPreview: {
    pageTitle: "Oluşturulan sorular önizleme",
    backToCreate: "Soru Oluştur",
    questionLabel: "Soru",
    confirmPrompt: "Emin misiniz?",
    confirmCancel: "Vazgeç",
    confirmDelete: "Sil",
    confirmDeleteQuestionMessage: (order: number) =>
      `${order}. soruyu silmek üzeresiniz.`,
    confirmDeleteOptionMessage: (order: number, optionKey: string) =>
      `${order}. sorunun ${optionKey} şıkkını silmek üzeresiniz.`,
    questionTypePrefix: "Soru Türü",
    edit: "Düzenle",
    statusApproved: "Onaylandı",
    statusDraft: "Taslak",
    statusPending: "Beklemede",
    viewMetodboxSource: "Metodbox'tan kaynak soruyu görüntüle",
    aiGenerated: "AI ile üretildi",
    expand: "Soruyu genişlet",
    collapse: "Soruyu daralt",
    correctAnswer: "Doğru cevap",
    wrongAnswer: "Yanlış cevap",
    deleteQuestion: "Soruyu sil",
    deleteOption: "Şıkkı sil",
    delete: "Sil",
